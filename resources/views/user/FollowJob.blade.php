                        ...
                        <div class="panel-body">
                            <div class="content">
                                <div class="container-fluid container-fixed-lg">
                                    <h5 class="page-title">ข้อมูลการแจ้งซ่อมของคุณ: <b>{{Auth::user()->name}}</b></h5>
                                </div>
                                <div class="container">
                                ...
                                <div class="container">
                                    <div>
                                        <div class="collapse" id="navbarToggleExternalContent">
                                                <form action="{{action('user\FollowJob@store')}}" method="post">
                                                    {{csrf_field()}}
                                                    <div class="col-lg-2">
                                                    ...
                                                    <button type="button"
                                                            onclick="location.href='{{action("user\FollowJob@index" )}}'"
