                        ...
                        <div class="panel-body">
                            <div class="content">
                                <div class="container-fluid container-fixed-lg">
                                    <h5 class="page-title">งานทั้งหมดในระบบ</h5>
                                </div>
                                <div class="container">
                                    <table id="myTable" class="table table-hover table-condensed">
                                        ...
                                        @foreach($jobs as $job)
                                            ...
                                            @if($status =='ทั้งหมด')
                                                <tr onclick="location.href='{{action('JobController@detailjob',$job->id)}}'">
                                                    <td>{{$job->id}}</td>
                                    ...
                                    <div>
                                        <div class="collapse" id="navbarToggleExternalContent">
                                                <form action="{{action('SearchController@store')}}" method="post">
                                                    {{csrf_field()}}
                                                    <div class="col-lg-3">
                                                        <input type="text" placeholder="คำค้นหา" name="search" class="form-control">
                                                    </div>
                                                    <div class="col-lg-2">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <select name="status" class="form-control">
                                                            ...
                                                            <option value="ตรวจสอบข้อมูลงานซ่อม">ตรวจสอบข้อมูลงานซ่อม</option>
                                                            ...
                                                            <option value="รอผลความพึงพอใจในงานซ่อม">รอผลความพึงพอใจในงานซ่อม
                                                            </option>
                                                    ...
                                                    <button type="button" class="btn btn-warning"
                                                            onclick="location.href='{{action("SearchController@index")}}'">
                                                        ล้างการค้นหา
                                                    </button>
                                                </form>
                                        </div>
