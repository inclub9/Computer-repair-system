                                ...
                                <div class="container">
                                    <table id="myTable" class="table table-hover table-condensed">
                                        ...
                                        @foreach($jobs as $job)
                                            ...
                                            @if($status =='ทั้งหมด')
                                                <tr onclick="location.href='{{action('JobController@detailjob2',$job->id)}}'">
                                                    <td>{{$job->id}}</td>
                                ...
                                <div class="container">
                                    <div>
                                        <div class="collapse" id="navbarToggleExternalContent">
                                            <div class="container">
                                                <form action="{{action('SearchControllerinfo@store')}}" method="post">
                                                    {{csrf_field()}}
                                                    <div class="col-lg-2">
                                                    ...
                                                    <button type="button" class="btn-warning btn"
                                                            onclick="location.href='{{action("SearchControllerinfo@index")}}'">
                                                        ล้างการค้นหา
                                                    </button>
                                                </form>
                                            </div>
