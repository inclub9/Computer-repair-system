                        ...
                        <div class="panel-body">
                            <div class="content">
                                <div class="container-fluid container-fixed-lg">
                                    <h5 class="page-title">ติดตามงานซ่อม</h5>
                                </div>
                                <div class="container">
                                    ...
                                    <div>
                                        <div class="collapse" id="navbarToggleExternalContent">
                                            <form class="form-group"
                                                  action="{{action('SearchController@SearchFollowJob')}}"
                                                  method="post">
                                                {{csrf_field()}}
                                                <div class="col-lg-2">
                                                ...
                                                <input class="btn btn-primary btn-cons m-b-10" type="submit"
                                                       value="ค้นหา">
                                                <button type="button" class="btn btn-warning btn-cons m-b-10"
                                                        onclick="location.href='{{action("SearchController@FollowJob")}}'">
                                                    ล้างการค้นหา
                                                </button>
                                            </form>
                                        </div>
